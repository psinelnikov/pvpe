...
contract Marketplace is Ownable {
    ...
    struct Listing {
        ...
        uint256 price;      // Price in PAVEL (native token)
        bool active;
    }
    ...
    /// @param price Price in PAVEL (native token)
    function list(
        address token,
        AssetType assetType,
        uint256 tokenId,
    ...
    /// @notice Buy a listed asset. Send PAVEL >= price.
    function buy(uint256 listingId) external payable {
        ...
        require(sent, "PAVEL transfer failed");
