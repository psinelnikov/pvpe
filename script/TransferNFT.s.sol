...
/// @title TransferNFT
/// @notice Transfers an NFT from the privacy ledger to the public chain via teleportToPublicChain().
///
...
/// Usage:
///   source .env
///   forge script script/TransferNFT.s.sol --rpc-url $PRIVACY_LEDGER_RPC_URL --broadcast --legacy
contract TransferNFT is Script {
    function run() external {
        ...
        console.log("");
        console.log("NFT is locked on the privacy ledger.");
